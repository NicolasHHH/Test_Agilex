...
import rospy
from scout_gazebo_sim.msg import  uwb_data
...
if __name__ == "__main__":
    ...
    print("get anchor pos ok")

    MODELSTATE_INDEX = rospy.get_param('/scout_gazebo_sim/modelstate_index',2)
    rospy.loginfo("%s is %s", rospy.resolve_name('/scout_gazebo_sim/modelstate_index'), MODELSTATE_INDEX)

    print("resolve name ok")
